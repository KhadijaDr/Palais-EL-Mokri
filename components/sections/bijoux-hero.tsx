...
export function BijouxHero() {
  return (
    <section className="relative h-[60vh] w-full overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/optimized/bijoux.webp"
          alt="Bijoux Traditionnels Marocains"
          fill
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center text-white max-w-4xl px-6">
          ...
          <p className="font-sans text-lg md:text-xl opacity-90 max-w-2xl mx-auto leading-relaxed text-shadow mb-4">
            Bijoux berbères et marocains en argent et pierres précieuses
          </p>
          <div className="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-white">
            <span className="text-sm font-medium">18 produits disponibles</span>
          </div>
        </div>
      </div>
    </section>
